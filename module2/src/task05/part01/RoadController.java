...
public class RoadController
{
    ...
    private static int calculatePrice(Car car)
    {
        ...
        else if (carHeight > passengerCarMaxHeight)
        {
            ...
            if (weight > passengerCarMaxWeight) // Грузовой автомобиль
            {
                price = cargoCarPrice;
            }
        }
        ...
        if (car.hasVehicle) {
        price = price + vehicleAdditionalPrice; // Прицеп
            System.out.println("У авто есть прицеп, доп.оплата: " + vehicleAdditionalPrice + " руб." );
        }
        return price;
    }
    /**
